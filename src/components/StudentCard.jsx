...
export default function StudentCard({ student, onClose, inBrowseView = false, cardId, isActive = false, onActivate }) {
  ...
  return (
    <div className={`student-card ${isActive ? "student-card-maximized" : ""}`}>
      ...
      >
        ...
        <img 
          src={!isActive ? "../public/assets/images/maximize.svg" : "../public/assets/images/minimize.svg"} 
          alt="" 
        />
      </button>
