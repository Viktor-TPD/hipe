      ...
      const response = await fetch(
        `http://localhost:4000/api/create-studentProfile`,
        {
          ...
          body: JSON.stringify({
            ...
            specialization: [data.specialization1, data.specialization2, data.specialization3],
            software: [data.software1, data.software2, data.software3],
            stack: data.stack,
            languages: [data.languages1, data.languages2, data.languages3],
